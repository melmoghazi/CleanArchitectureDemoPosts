...
namespace DemoPosts.Persistence.Migrations
{
    ...
    [Migration("20241126054602_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoPosts.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DemoPosts.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoPosts.Domain.Post", b =>
                {
                    b.HasOne("DemoPosts.Domain.Category", "Category")
                        .WithMany("Blogs")
